...
contract BadPacking {
    uint128 a;      // slot 0: used 16/32 bytes
    uint256 b;      // slot 1: used 32/32 bytes
    uint128 c;      // slot 2: used 16/32 bytes (wasted 128 bits)
    uint256 d;      // slot 3: used 32/32 bytes
    bool e;         // slot 4: used 1/32 bytes
    address f;      // slot 4: used 20/32 bytes (packed!)
    uint8 g;        // slot 4: used 1/32 bytes (packed!)
    // Total: 5 slots
}
...
contract ExamplePacking {
    ...
    // use storage
    uint128 public balance;     // slot 0: (16 bytes)
